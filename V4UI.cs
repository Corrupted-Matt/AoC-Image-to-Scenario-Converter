...
namespace AoC_Image_to_Scenario_Converter
{
    public partial class V4UI : Form
    {
        ...
        private void V4UI_Load(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "Low\\JoySparkGames\\Ages of Conflict")) // this thing gets a hold of the scenario directory, still quite shocked this isn't an access violation
        ...
        public async void GenerateButton_Click(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(OutputDest + $"\\{SelectedName}"))
            {
                SystemSounds.Hand.Play();
